        ...
        <div class="col-span-12">
            <div v-if="userStore.currentUser">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-6">
                    ...
                    <template v-else>
                        <div v-for="zone in zones" :key="zone.id" class="bg-white rounded-lg shadow-md p-4 hover:shadow-lg transition cursor-pointer flex flex-col justify-between">
                        ...
                        <div class="bg-white rounded-lg shadow-md p-4 hover:shadow-lg transition cursor-pointer flex items-center justify-center" @click="showPopupCreate = true">
